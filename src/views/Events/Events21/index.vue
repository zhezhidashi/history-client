...
<script>
import Search from "@/views/Events/Events21/Search";
import Condition from "@/views/Events/Events21/Condition";
import Result from "@/views/Events/Events21/Result";
